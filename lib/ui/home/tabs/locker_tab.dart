...
class LockerTab extends HookConsumerWidget implements CobbleScreen {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final connectionState = ref.watch(connectionStateProvider.state);

    final currentWatch = connectionState.currentConnectedWatch;

    final appManager = ref.watch(appManagerProvider);
    List allPackages = ref.watch(appManagerProvider.state);
